...
[`@aws-sdk/client-personalize-runtime`](https://www.npmjs.com/package/@aws-sdk/client-personalize-runtime/v/3.936.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-personalize-runtime@3.936.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-4RPI4wklyI3Y0IJLUtJS/bcID9LS4rwc73JP0gudIigONSXe+cvVcZLI1+LD+ZTC
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-personalize-runtime": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-personalize-runtime@3.936.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-personalize-runtime@3.936.0/index.min.mjs": "sha384-4RPI4wklyI3Y0IJLUtJS/bcID9LS4rwc73JP0gudIigONSXe+cvVcZLI1+LD+ZTC"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-personalize-runtime/blob/refs/tags/3.936.0/LICENSE
```
