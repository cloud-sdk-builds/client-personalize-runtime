...
[`@aws-sdk/client-personalize-runtime`](https://www.npmjs.com/package/@aws-sdk/client-personalize-runtime/v/3.414.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-personalize-runtime@3.414.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-X3KYq/OGkpavSHvCDA0B7y2EfDCy40wmX3rb3blF1POyWh8l27TOHnTbIoz65NMH
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-personalize-runtime": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-personalize-runtime@3.414.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-personalize-runtime@3.414.0/index.min.mjs": "sha384-X3KYq/OGkpavSHvCDA0B7y2EfDCy40wmX3rb3blF1POyWh8l27TOHnTbIoz65NMH"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-personalize-runtime/blob/refs/tags/3.414.0/LICENSE
```
